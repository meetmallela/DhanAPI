...
from agents.omni_signal_trader      import OmniSignalTrader, ensure_trader_columns
...
def build_and_run(is_sandbox: bool = True):
    ...
    # ── 9m-ii. Unified OmniSignal Trader ──────────────────────────────────
    # Monitors pattern_alerts and pa_setups for confluence and separate signals;
    # resolves confluence matches; dynamically sizes positions; places option orders.
    ensure_trader_columns()
    pat_trader = OmniSignalTrader(dhan_client=engine.client)
