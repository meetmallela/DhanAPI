...
Output:
    MasterConfiguration/reports/Strategy_Praposed_20260531_v104.xlsx
...
OUTPUT = _MASTER / "reports" / "Strategy_Praposed_20260531_v104.xlsx"
...
def write_executive_summary(ws, all_data):
    ...
    title_row(ws, 1, 16,
              "Strategy Assessment v104  |  Final Configuration  |  "
...
def write_optimization_changes(ws):
    ...
    title_row(ws, 1, 10,
              "v104 Parameter Changes -- GapFill & ORB15 Optimization Reports (May 31 2026)",
              height=28)
...
def main():
    print("=" * 60)
    print("  Strategy Assessment v104 -- Building Excel")
    print("=" * 60)
